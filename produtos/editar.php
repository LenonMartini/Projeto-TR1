<?php
    ...
    $sql = "SELECT p.*,ap.uso_recomendado as uso FROM tb_produto AS p INNER JOIN tb_ambiente_produto as ap on ap.id_produto = p.id  WHERE p.id = $id";
    ...
    $query_ambiente_prod = mysqli_query($dataBase, "SELECT ap.*, a.nome as ambientenome FROM tb_ambiente_produto  as ap
                                            inner  join tb_ambiente as a on  
                                            a.id = ap.id_ambiente  WHERE ap.id_produto = $id");

    $ids_ambiente_prod = [];

    while($r = mysqli_fetch_object($query_ambiente_prod)) {
        array_push($ids_ambiente_prod, $r->id_ambiente);
    }
...
<style type="text/css">
    ...
    .text-core .text-wrap textarea, .text-core .text-wrap input, .text-core .text-wrap {
        width: 100% !important;
    }
        ...
        <form action="salvar.php" method="post" class="cell" enctype="multipart/form-data">
            ...
            <div class="tabs-content" data-tabs-content="template-page-tabs">
                <div class="tabs-panel is-active" id="defaultpage">
                    ...
                    <input type="hidden" id="foto1_antiga" name="foto1_antiga" value="<?= $produto->foto1 ?>" />
                    <input type="hidden" id="foto2_antiga" name="foto2_antiga" value="<?= $produto->foto2 ?>" />
                    <input type="hidden" id="foto3_antiga" name="foto3_antiga" value="<?= $produto->foto3 ?>" />
                    ...
                    <div class="grid-x">
                        <div class="large-45">
                            <div class="grid-x">
                                ...
                                <div class="cell">
                                    <label>Descrição
                                        <textarea name="descricao" id="descricao" rows="10" cols="80"><?= $produto->descricao ?></textarea>
                                    </label>
                                </div>
                                ...
                                <div class="cell">
                                    <div class="container-imagens">
                                        <div class="card-imagem">
                                            <div class="imagem">
                                                <img id="preview-foto1" class="image-contain-h-200" src="<?= exibir_imagem($produto->foto1) ?>" loading="lazy" />
                                                <button type="button" class="btn-remover-imagem <?= $produto->foto1 == "" ? 'd-none' : '' ?>" data-image="foto1">
                                                    x
                                                </button>
                                            </div>
                                        ...
                                        <div class="card-imagem">
                                            <div class="imagem">
                                                <img id="preview-foto2" class="image-contain-h-200" src="<?= exibir_imagem($produto->foto2) ?>" loading="lazy" />
                                                <button type="button" class="btn-remover-imagem <?= $produto->foto2 == "" ? 'd-none' : '' ?>" data-image="foto2">
                                                    x
                                                </button>
                                            </div>
                                        ...
                                        <div class="card-imagem">
                                            <div class="imagem">
                                                <img id="preview-foto3" class="image-contain-h-200" src="<?= exibir_imagem($produto->foto3) ?>" loading="lazy" />
                                                <button type="button" class="btn-remover-imagem <?= $produto->foto3 == "" ? 'd-none' : '' ?>" data-image="foto3">
                                                    x
                                                </button>
                                            </div>
                                    ...
                                    <div class="grid-x">
                                        ...
                                        <div class="cell">
                                            ...
                                            <select id="recomendado" name="recomendado" required>
                                                <option value="1" <?= $produto->uso == '1' ? 'selected' : ''; ?>>Para Empresas</option>
                                                <option value="2" <?= $produto->uso == '2' ? 'selected' : ''; ?>>Para Casas</option>
                                                <option value="3" <?= $produto->uso == '3' ? 'selected' : ''; ?>>Para Uso Pessoal</option>
                                                <option value="4" <?= $produto->uso == '4' ? 'selected' : ''; ?>>Para Casa/Empresa </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="cell">
                                            <div class="radius bordered shadow card" style="max-height: 320px; overflow-y: auto;">
                                                <div class="card-divider">
                                                    <span style="display: block;">Indicado para </span>
                                                </div>
                                                <div class="card-section">
                                                    <?php $i=0; while ($row = mysqli_fetch_object($query_ambientes)) : ?>
                                                        <label class="cursor-pointer">
                                                            <input 
                                                                type="checkbox" 
                                                                name="ambiente[]" 
                                                                value="<?= $row->id; ?>"
                                                                <?=  in_array($row->id, $ids_ambiente_prod) ? 'checked'  : ''; ?>
                                                            />
                                                            <?= $row->nome; ?>
                                                        </label>
                                                    <?php $i++; endwhile; ?>
                                            ...
                                            <label>Categoria
                                                <select name="categoria" required>
                                                    ...
                                                    <?php while ($row = mysqli_fetch_object($query_categorias)) : ?>
                                                        <option value="<?= $row->id; ?>" <?= $row->id == $produto->id_categoria ? 'selected' : ''; ?>>
                                                            <?= $row->nome; ?>
                                                        </option>
                                                    <?php endwhile; ?>
                                                </select>
                                            ...
                                            <label>Tipo
                                                <select name="tipo" required>
                                                    ...
                                                    <?php while ($row = mysqli_fetch_object($query_tipos)) : ?>
                                                        <option value="<?= $row->id; ?>" <?= $row->id == $produto->id_marca ? 'selected' : ''; ?>>
                                                            <?= $row->nome; ?>
                                                        </option>
                                                    <?php endwhile; ?>
                                                </select>
                                        ...
                                        <div class="cell">
                                            <label>Desconto (%)
                                                <input type="number" name="desconto" id="desconto"  min="0" max="100" value="<?=$produto->desconto *100?>">
                                            </label>
                                        </div>
                    ...
                    <div class="grid-x">
                        <div class="d-flex align-items-center cell text-right" style="padding: 1rem 0; gap: 0.5rem;">
                            <div class="switch tiny">
                                <input class="switch-input" type="checkbox" id="exibir_pagina_especial" name="exibir_pagina_especial" <?= $produto->exibir_pagina_especial ? 'checked' : ''; ?> />
                        ...
                        <div class="cell">
                            ...
                            <div class="tabs-content" data-tabs-content="secoes-tabs">
                                <div class="tabs-panel is-active" id="secao-principal">
                                    <div class="cell">
                                        <label>Título
                                            <input 
                                                ...
                                                type="text" 
                                                placeholder="Titulo" 
                                                value="<?= $dadosPaginaEspecial->titulo; ?>" 
                                    ...
                                    <div class="cell">
                                        <label>Descrição
                                            <textarea name="paginaespecial-descricao" id="paginaespecial-descricao" rows="10" cols="80"><?= $dadosPaginaEspecial->descricao ?></textarea>
                                        </label>
                                    </div>
                                    <div class="cell">
                                        <label>Link (Saiba mais)
                                            <input 
                                                ...
                                                value="<?= $dadosPaginaEspecial->link; ?>"  
                                            />
                                        </label>
                                    </div>
                                    ...
                                    <div class="card-imagem">
                                        <div class="imagem">
                                            <img id="preview-foto-fundo1" class="image-contain-h-200" src="<?= exibir_imagem($dadosPaginaEspecial->foto_fundo1, "produto/bg") ?>" loading="lazy" />
                                            <button type="button" class="btn-remover-imagem <?= $dadosPaginaEspecial->foto_fundo1 == "" ? 'd-none' : '' ?>" data-image="foto-fundo1">
                                                x
                                            </button>
                                        </div>
                                    ...
                                    <input type="hidden" id="foto-fundo1_antiga" name="foto-fundo1_antiga" value="<?= $dadosPaginaEspecial->foto_fundo1; ?>" />
                                </div>
                                <div class="tabs-panel" id="secao-secundaria">
                                    <div class="cell">
                                        <label>Título
                                            <input 
                                                ...
                                                type="text" 
                                                placeholder="Titulo" 
                                                value="<?= $dadosPaginaEspecial->titulo2; ?>" 
                                    ...
                                    <div class="cell">
                                        <label>Descrição
                                            <textarea name="paginaespecial-descricao2" id="paginaespecial-descricao2" rows="10" cols="80"><?= $dadosPaginaEspecial->descricao2 ?></textarea>
                                        </label>
                                    </div>
                                    <div class="cell">
                                        ...
                                        <?php if($dadosPaginaEspecial->arquivo) { ?>
                                            <a href="<?= PATH_IMG."produto/arquivos/".$dadosPaginaEspecial->arquivo; ?>" target="_blank">
                                                Visualizar arquivo
                                            </a>
                                        <?php } ?>
                                        ...
                                        <input type="hidden" id="paginaespecial-arquivo_antigo" name="paginaespecial-arquivo_antigo" value="<?= $dadosPaginaEspecial->arquivo ?>" />
                                    ...
                                    <div class="card-imagem">
                                        <div class="imagem">
                                            <img id="preview-foto-fundo2" class="image-contain-h-200" src="<?= exibir_imagem($dadosPaginaEspecial->foto_fundo2, "produto/bg") ?>" loading="lazy" />
                                            <button type="button" class="btn-remover-imagem <?= $dadosPaginaEspecial->foto_fundo2 == "" ? 'd-none' : '' ?>" data-image="foto-fundo2">
                                                x
                                            </button>
                                        </div>
                                    ...
                                    <input type="hidden" id="foto-fundo2_antiga" name="foto-fundo2_antiga" value="<?= $dadosPaginaEspecial->foto_fundo2 ?>" />

                                </div>
                                <div class="tabs-panel" id="secao-video">
                                    <div class="card-imagem">
                                        <div class="imagem">
                                            <img id="preview-foto-fundo3" class="image-contain-h-200" src="<?= exibir_imagem($dadosPaginaEspecial->foto_fundo3, "produto/bg") ?>" loading="lazy" />
                                            <button type="button" class="btn-remover-imagem <?= $dadosPaginaEspecial->foto_fundo3 == "" ? 'd-none' : '' ?>" data-image="foto-fundo3">
                                                x
                                            </button>
                                        </div>
                                    ...
                                    <input type="hidden" id="foto-fundo3_antiga" name="foto-fundo3_antiga" value="<?= $dadosPaginaEspecial->foto_fundo3 ?>" />
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function urlnizer() {
        var canonic = $("#url").val();
        if (canonic == '') return;
        $.post("../urlnizer.php", { url: canonic, type: "produto", id: <?= $produto->id ?> })
            .done(function (data) {
        ...
        if (event.target.files.length > 0) {
            ...
            img.onload = function handleLoad() {
                if (img.width > 1024 || img.height > 768) {
                    alert(`Infelizmente, a imagem selecionada ultrapassa as dimensões recomendadas (1024x550). Tente novamente...`);
